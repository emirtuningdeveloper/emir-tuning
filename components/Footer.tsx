    ...
    <footer className="bg-anthracite-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Otomotiv tuning dünyasında profesyonel çözümler sunuyoruz. 
              Kaliteli ürünler ve uzman hizmetlerimizle araçlarınıza değer katıyoruz.
            </p>
          </div>
        ...
        <div className="border-t border-anthracite-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Emir Tuning. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  )
